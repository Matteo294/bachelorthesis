...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \foreach \x in {-3,-2,...,3}{
        \foreach \y in {-3,-2,...,3}{
            \draw [->, line width=0.3mm] (\x/1.5,\y/1.5-0.15) -- (\x/1.5,\y/1.5+0.15);
        }
      }
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \hfill\begin{minipage}[t]{0.45\textwidth}
        ...
        \captionof*{figure}{\hspace{20pt}T = \SI{0.01}{\kelvin}}
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[scale=0.45]{./images/ising/T_n001_ferro.eps}
        \captionof*{figure}{\hspace{20pt} T = \SI{-0.01}{\kelvin} (zoomed)}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{\textwidth}
        \centering
        \includegraphics[scale=0.45]{./images/ising/T_100_ferro.eps}
        \captionof*{figure}{T = \SI{100}{\kelvin}}
    \end{minipage}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \foreach \xx in {1,3}{
            \foreach \yy in {-2,...,1}{
                \draw [->, color=black!50, line width=0.3mm] (\xx/1.5,\yy/1.5-0.15) -- (\xx/1.5,\yy/1.5+0.15);
            }
        }
        \foreach \xx in {2,4}{
            \foreach \yy in {-2,...,1}{
        ...
        \node[align=left] at (-1,-2) {S1};
        \node[align=left] at (2.5/1.5,-2) {S2};
        \node[align=left] at (0.5/1.5,-2.7) {S};
    \end{tikzpicture}
